// component Portfolio: header , table structure

//Populate input with som initial data in component state
//Calculate Market Value & Unrealise gain/loss:
//Market value = shares owned * market price
//Unrealised Gain/Loss = Market value -shares owned * cost_per_share
// Calculate total market value and gain/loss. -> runa reduce function
//Remove a stock: the portfolio is in array object -> remove the corresponding object from the array
// Make the input elements editable: use index value from the mapmethod to pinpoint the object in the portfolio array
...
class Portfolio extends React.Component {
  ...
  removeStock(index) {
    ...
    portfolio.splice(index, 1); //remove value at index. index is vaue from map method to pinpoint the target object in array
  ...
  render() {
    ...
    //calculate total sumofmrket value and unrealised gain/loss
            ...
            <table className="table table-responsive">
              <thead>
                <tr>
                  ...
                  <th scope="col">Cost Per Shares ($)</th>
              ...
              <tbody>
                {portfolio.map((stock, index) => {
                  const { name, shares_owned, cost_per_share, market_price } =
                    stock; //stock is passed into props (object)
